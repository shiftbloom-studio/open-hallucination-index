/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: c1658274253042b063f7c3f5b4cf63c8)
// Runtime types generated with workerd@1.20260701.1 2026-07-05 nodejs_compat
interface __BaseEnv_Env {
	OHI_CORPUS: R2Bucket;
	OHI_DB: D1Database;
	OHI_VECTOR: VectorizeIndex;
	VERIFY_QUEUE: Queue;
	CORPUS_QUEUE: Queue;
	AI: Ai;
	ASSETS: Fetcher;
	...
	VERIFY_MAX_CLAIMS: "13";
	VERIFY_RATE_LIMIT_PER_MINUTE: "12";
	MAXIMUM_RIGOR_COOLDOWN_SECONDS: "90";
	JOBS: DurableObjectNamespace<import("./index").JobObject>;
	MCP_OBJECT: DurableObjectNamespace<import("./index").OhiMCP>;
	RATE_LIMITER: DurableObjectNamespace<import("./index").RateLimitObject>;
	CORPUS_WORKFLOW: Workflow<Parameters<import("./index").CorpusIngestionWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "JobObject" | "OhiMCP" | "RateLimitObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SITE_ORIGIN" | "VERIFY_MAX_CLAIMS" | "VERIFY_RATE_LIMIT_PER_MINUTE" | "MAXIMUM_RIGOR_COOLDOWN_SECONDS">> {}
}
