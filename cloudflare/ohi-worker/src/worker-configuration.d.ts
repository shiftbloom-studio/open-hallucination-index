/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: f89cc9cdff3eba6d7fc65127a4f5e936)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SITE_ORIGIN" | "VERIFY_MAX_CLAIMS" | "VERIFY_RATE_LIMIT_PER_MINUTE">> {}
}
